 ...
 * common fork-join framework and the Java sequential streams
 * framework to perform an "image crawl" starting from a root Uri.
 * Images from an HTML page reachable from the root Uri are downloaded
 * in parallel from a remote web server or the local file system,
 * transformed, and then stored in files on the Android device, where
 * they can be displayed to the user.
 *
 * This implementation should use Java streams features and should
 ...
 */
public class ForkJoinExCrawler
     ...
     */
    protected ForkJoinTask<Image> makePerformTransformTask(Image image, Transform transform) {
    ...
    public class URLCrawlerTask
        ...
        protected Integer compute() {
            ...
            // solution that uses a Java stream to check if the
            // current depth is within the max depth and if the URI
            // hasn't been visited before and then calls a helper
            // method to crawl the page.
            return 0;
        }
        ...
        protected int crawlPage(String pageUri, int depth) {
            // TODO -- you fill in here replacing 'return 0' with your
            // solution that uses a Java stream to get the HTML page
            // associated with the pageUri and then processes the
            // page.  Use a helper method to expand the Java common
         ...
         */
        protected int processPage(Crawler.Page page, int depth) {
            // TODO -- you fill in here replacing this statement below
            // with your solution that uses a Java sequential stream
            // and helper methods to get all the IMAGE and PAGE
            // elements from the page and then uses the Java fork-join
            // framework via intermediate streams operations to
            // crawl/count them accordingly and return a sum of the
            // number of images processed.
            List<ForkJoinTask<Integer>> forks = null;

            // Call a helper method that joins all the forked tasks
            // and returns a sum of the number of images returned from
            // each task.
            // TODO -- you fill in here replacing return 0 with your
            // solution.
            return 0;
        ...
        protected int sumResults(List<ForkJoinTask<Integer>> forks) {
            // TODO -- you fill in here replacing 'return 0' with your
            // solution that uses a Java sequential stream to join all
            // the ForkJoinTasks and returns a sum of the number of
    ...
    public class ProcessImageTask
        ...
        protected Integer compute() {
            ...
            // your solution that uses a Java sequential stream to
            // either gets or downloads an image from the given URL
            // (depending on whether it's cached or not) using helper
            // methods defined in the ImageCrawler super class and
            // this class using a ManagedBlocker.
            return null;
        }
        ...
        protected int transformImage(Image image) {
            ...
            //  your solution that use a Java sequential stream to
            //  apply the current set of crawler transforms on the
         ...
         * images returned from each task.
         *
         * @param forks A {@link List} of {@link ForkJoinTask} objects
         *              containing number of {@link Image} objects
        ...
        protected int countTransformations(List<ForkJoinTask<Image>> forks) {
            // TODO -- you fill in here replacing 'return 0' with your
            // solution that uses a Java sequential stream to join all
            // the forked tasks and counts the number of non-null
            // images returned from each task.
            return 0;
        }
    }
    ...
    public class PerformTransformTask
        ...
        protected Image compute() {
            // TODO -- you fill in here replacing 'return null' with
            // your solution that uses a Java sequential stream to
            // filter, transform, and store an Image using helper
            // methods defined in the ImageCrawler superclass.
            return null;
        }
    }
}
