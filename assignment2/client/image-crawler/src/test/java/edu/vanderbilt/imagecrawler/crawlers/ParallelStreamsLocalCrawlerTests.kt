...
class ParallelStreamsLocalCrawlerTests : AssignmentTests() {
    @SpyK
    var mockCrawler = ParallelStreamsCrawler()
    ...
    fun `transformImageLocally() uses expected chained method calls`() {
        ...
        every { mockTransforms.parallelStream() } returns mockTransformStream
