...
public class WebPageCrawler
    ...
    protected static class DocumentPage implements Page {
         ...
         */
        @Override
        public Stream<WebPageElement> getPageElementsAsStream(@NotNull Type... types) {
            if (types.length == 0) {
         ...
         */
        @Override
        public List<WebPageElement> getPageElements(@NotNull Type... types) {
            ImageCrawler.throwExceptionIfCancelled();
         ...
         */
        @Override
        public Stream<String> getPageElementsAsStringStream(@NotNull Type... types) {
            return getPageElementsAsStream(types)
         ...
         */
        @Override
        public List<String> getPageElementsAsStrings(@NotNull Type... types) {
            return getPageElementsAsStream(types)
                    .map(WebPageElement::getUrl)
                    .collect(toList());
        }
         ...
         */
        @Override
        public List<URL> getPageElementsAsUrls(@NotNull Type... types) {
            return getPageElementsAsStream(types)
                .map(WebPageElement::getURL)
                .collect(toList());
        }
