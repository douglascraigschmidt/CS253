...
/**
 * This {@link ImageCrawler} implementation strategy uses the
 ...
 * the user.  Likewise, image processing is either performed locally
 * on the client device or remotely using reactive microservices
 * deployed on one or more servers via Spring WebFlux.
 *
 * All stream operations are performed sequentially in a single thread
 * of control.
 */
...
public class SequentialStreamsCrawler // Loaded via reflection
    ...
    protected int processImage(URL imageUrl) {
        ...
        //    downloadImage method reference if the url isn't cached.
