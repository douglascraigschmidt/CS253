 ...
 * and return a {@link Mono} that emits a list of {@link
 * TransformedImage} objects.  This class also plays the role of a
 * Eureka "client" wrt microservice discovery.
 *
...
public class MainApplication {
    /**
     * A static main() entry point is needed to run the ImageCrawler
     * microservice.
     */
