...
public class CompletableFuturesCrawler
    ...
    protected CompletableFuture<Integer>
        ...
        // method should use a completion stage method to call the
        // crawlHyperLinksOnPage() helper method asynchronously.
     ...
     * @return A {@link CompletableFuture} to the combined results of
     *         the two {@link CompletableFuture} params after they
     *         complete
     */
    protected CompletableFuture<Integer>
     ...
     * @return A {@link CompletableFuture to an {@link Integer} that
     *         counts how many images were downloaded, stored, and
     *         transformed for all {@code urls} on the page
     */
    protected CompletableFuture<Integer> processImages(List<URL> urls) {
