...
public class ParallelStreamsCrawler // Loaded via reflection
    ...
    protected int performCrawl(String pageUri, int depth) {
        ...
        // sequential stream, it should also use the correct parallel
    ...
    protected Stream<Image> processImage(URL imageUrl) {
        ...
        // method uses a sequential stream, it should also the correct
        // parallel streams idiom for (1) first mapping a URL to a
        // stream containing an image from the cache or from a source
        // and (2) then converting that image into a stream of
        // transformed images.
        return null;
    }
