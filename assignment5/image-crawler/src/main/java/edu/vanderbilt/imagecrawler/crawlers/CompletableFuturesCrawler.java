...
public class CompletableFuturesCrawler
     ...
     *         containing the # of images downloaded/transformed/
     *         stored on this page
     */
    protected CompletableFuture<Integer>
     ...
     * of images downloaded/stored via this crawl.
     *
    ...
    /**
     * Combines/sums the results of two {@link CompletableFuture}
     * parameters.
     *
     ...
     *         counts how many images were in each hyperlink on the
     *         page
     */
    protected CompletableFuture<Integer> crawlHyperLinksOnPage
        (Crawler.Page page,
         int depth) {
        // TODO -- you fill in here replacing 'return null' with your
     ...
     * Stream} of {@code urls}.
     *
     * @param urls A {@link Stream} of URLs corresponding to images on
     *            the page
     * @return A {@link CompletableFuture to an {@link Integer} that
     ...
     * @return A {@link CompletableFuture} to an stream of {@link
     *         Image} objects indicating the transform operation(s)
     *         success or failure
     */
     ...
     *
     * @param transform The {@link Transform} to apply to the {@link
     *                  Image}
     * @param image The {@link Image} to transform and store in the
     *              cache
