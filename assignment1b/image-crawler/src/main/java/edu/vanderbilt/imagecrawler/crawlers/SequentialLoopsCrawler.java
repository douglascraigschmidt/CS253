...
import static edu.vanderbilt.imagecrawler.utils.Student.graduateTodo;
import static edu.vanderbilt.imagecrawler.utils.Student.undergraduateTodo;
    ...
    protected int crawlPage(String pageUri, int depth) {
        ...
        if (undergraduateTodo()) {
            ...
            page.getPageElements(IMAGE, PAGE).forEach(e -> {
                ...
                if (e.getType() == IMAGE) {
                    imageCount[0] += processImage(getOrDownloadImage(e.getURL()));
                } else {
