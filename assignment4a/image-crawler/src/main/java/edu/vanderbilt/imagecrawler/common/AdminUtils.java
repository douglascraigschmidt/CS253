...
/**
 * A Java utility class containing static methods used for project
...
public final class AdminUtils {
    ...
    public static void indexDirectory(File dir) {
        ...
        String dirsStub = dirs.stream()
                .map(file -> String
                    .format(mDirFormat, file.getName(), file.getName()))
                .reduce((s, s1) -> s + s1)
                .orElse("");
        ...
        try {
            ...
            String mIndexFormat = "<html><head><meta http-equiv=\"Content-Type\" "
