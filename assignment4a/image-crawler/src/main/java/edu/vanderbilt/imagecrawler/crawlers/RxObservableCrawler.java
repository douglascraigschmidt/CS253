...
/**
 * This class uses the RxJava {@link Observable} class to perform a
 * reactive image crawl starting from a root Uri.  Images from HTML
 * pages reachable from the root Uri are asynchronously downloaded
 * from a remote web server or from the local file system,
...
public class RxObservableCrawler
     ...
     */
    protected Observable<Image> imagesOnPageAndPageLinksAsync
        (Crawler.Page page,
         int depth) {
    ...
    protected Observable<Image> imagesOnPageLinksAsync
        ...
        // 
        // 1. Use a factory method to convert the list of page links
        //    into an Observable stream of page links.
        // 
    ...
    protected Observable<Image> imagesOnPageAsync(Crawler.Page page) {
        ...
        // 
        // 1. Use a factory method to convert the list of images in
        //    the page into an Observable stream.
        // 
