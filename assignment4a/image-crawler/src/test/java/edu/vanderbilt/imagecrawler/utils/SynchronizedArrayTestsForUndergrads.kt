...
class SynchronizedArrayTestsForUndergrads : SynchronizedArrayTestsBase() {
    /**
    ...
    @Test
    override fun testConstructorWithArray() {
        super.testConstructorWithArray()
    }

    @Test
    override fun testConstructorWithCollection() {
        super.testConstructorWithCollection()
    }
